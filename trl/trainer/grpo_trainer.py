...
class GRPOTrainer(Trainer):
    ...
    def _generate_completions(
        self, prompt_ids: torch.Tensor, prompt_mask: torch.Tensor, prompts_text: list
    ) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        """
        Generate completions for given prompts using either vLLM or regular generation.

        Args:
            prompt_ids: Tensor of prompt token IDs
            prompt_mask: Attention mask for prompt tokens
            prompts_text: List of prompt texts

        Returns:
            tuple of (prompt_completion_ids, prompt_ids, completion_ids)
        """
        ...
        return prompt_completion_ids, prompt_ids, completion_ids
    ...
    def _generate_and_score_completions(
        ...
        # Call the extracted generation method
